const contentLetterSrart_actived = "Xin chào tiểu thư, tiểu thư hãy ấn vòa hộp quà để nhận những lời yêu thương của ta đi." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc bé thi sinh nhật vui vẻ ạ, tuổi mới ngày càng xinh đẹp hơn ạ, may mắn đáng iu nè, và mong cậu để ý đến tui hơn một chút, một chút hơn so với trước là được rùi <3 mãi iu" 
